...
class MercadoPagoTest {
    ...
    @Test
    void should_create_a_request_payment() throws MPException {
    ...
    @Test
    void should_test_payment() throws MPException {
    ...
    @Test
    void transform_json_string_in_object() throws JSONException {
